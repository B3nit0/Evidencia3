...
public class Practica_03_D {
    private static HashMap<Integer, Practica_03_C> Baraja = null;
    ...
    public static void CargaDatosInicio(){
        ...
        for (int nR = 0; nR < 4; nR++) {
            ...
            for (int nRV = 0; nRV < 14; nRV++) {
                ...
                Baraja.put(nRenglonP, new Practica_03_C(sPalo, sColor, sValor));
                nRenglonP++;
            }
        }
    }
    ...
    public static void Shuffle(){
        ...
        try {
            ...
            HashMap<Integer, Practica_03_C> shuffledBaraja = new HashMap<>();
    ...
    private static void BorraRenglon(Integer[] nRBorrar) {
        ...
        for (nRB = 0; nRB < nRBorrar.length; nRB++){
            ...
            nRM = 0;
            for (Map.Entry<Integer, Practica_03_C> item : Baraja.entrySet()) {
